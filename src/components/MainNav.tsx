            ...
            <Sheet>
              ...
              <SheetContent side="right">
                <div className="flex flex-col gap-4 mt-8">
                  ...
                  <Button variant="ghost" className="justify-start" onClick={() => handleNavigation('/news')}>News</Button>
                  <Button variant="ghost" className="justify-start" onClick={() => handleNavigation('/support')}>Support</Button>
                  <div className="border-t border-white/10 pt-4 mt-4">
                    <Button variant="ghost" className="justify-start" onClick={() => handleNavigation('/profile')}>Profile</Button>
                    <Button variant="ghost" className="justify-start" onClick={() => handleNavigation('/settings')}>Settings</Button>
